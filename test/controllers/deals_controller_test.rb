...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { deal: @deal.deal, description: @deal.description, end_time: @deal.end_time, start_time: @deal.start_time }
    end
  ...
  test "should update deal" do
    patch :update, id: @deal, deal: { deal: @deal.deal, description: @deal.description, end_time: @deal.end_time, start_time: @deal.start_time }
    assert_redirected_to deal_path(assigns(:deal))
  end
